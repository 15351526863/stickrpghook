...
public:
	...
	void Create( C_BaseEntity* pEntity )
	{
		using CreateAnimationStateFn = void( __thiscall* )( void*, C_BaseEntity* );
		static auto oCreateAnimationState = reinterpret_cast< CreateAnimationStateFn >( Utils::FindSignature( "client.dll", "55 8B EC 56 8B F1 B9 ? ? ? ? C7 46" ) ); // @xref: "ggprogressive_player_levelup"
	...
	void Update( Vector& ang )
	{
		...
		static auto oUpdateAnimationState = reinterpret_cast< UpdateAnimationStateFn >( Utils::FindSignature( "client.dll", "55 8B EC 83 E4 F8 83 EC 18 56 57 8B F9 F3 0F 11 54 24" ) ); // @xref: "%s_aim"

		if ( oUpdateAnimationState == nullptr )
			return;

		oUpdateAnimationState( this, nullptr, 0.0f, ang.y, ang.x, nullptr );
	}

	void Reset( )
	{
		using ResetAnimationStateFn = void( __thiscall* )( void* );
		static auto oResetAnimationState = reinterpret_cast< ResetAnimationStateFn >( Utils::FindSignature( "client.dll", "56 6A 01 68 ? ? ? ? 8B F1" ) ); // @xref: "player_spawn"
...
public:
	...
	{
		Utils::GetVFunc<void( __thiscall* )( void* )>( this, 224 )( this );
	}
	...
	Vector GetEyePosition( )
	{
		...
		Utils::GetVFunc<OrigFn>( this, 285 )( this, ret );
		return ret;
	}
	...
	std::array<float, PoseParam_Count>& GetPoseParams( )
	{
		return *reinterpret_cast< std::array<float, PoseParam_Count>* >( ( uintptr_t ) this + netvar::data[ hash::CompileTime( "CBaseAnimating->m_flPoseParameter") ] );
	}

	uint32_t& MostRecentModelBoneCounter( )
	{
		static auto invalidateBoneCache = Utils::FindSignature( "client.dll", "80 3D ? ? ? ? ? 74 16 A1 ? ? ? ? 48 C7 81" );
