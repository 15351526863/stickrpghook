...
namespace vtable_indexes
{
	...
	constexpr auto extraBonePro	= 198;
...
public:
	...
	static void		__stdcall	CreateMove(int sequence_number, float input_sample_frametime, bool active, bool& send_packet);
	static void		__fastcall	CreateMoveProxy(void* _this, int, int sequence_number, float input_sample_frametime, bool active);
